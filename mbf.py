#DIBUAT  20 APR 2023
#LU KALO BERANI RECODE GW DOAIN ERROR:<
...
{B}╠╣ {W}├─┤│  ├┤ ├┴┐│ ││ │├┴┐{R}───{B}║║║{W}├┴┐├┤ 
{B}╚  {W}┴ ┴└─┘└─┘└─┘└─┘└─┘┴ ┴   {B}╩ ╩{W}└─┘└  ''')
    print('' + Back.BLUE + Fore.BLACK + '        Creator : Chandrika         \033[00m')
    print('' + Back.BLUE + Fore.BLACK + '        Facebook : Chandrika Pro         \033[00m')
    print('' + Back.BLUE + Fore.BLACK + '        Github : ChandrikaProCodeId         \033[00m')
    print()
...
def masuk():
    try:
          ...
          cek = input("\033[00mMasukin Cookies : \033[1;96m")
    cek = {"cookie":cek}
